...
function Login(props) {
  ...
  const formValChange = (e) => {
    ...
    switch (name) {
      case "mobile":
        isError.mobile = regExpMobile(value)
          ? "Enter valid mobile number"
          : value.length !== 10
          ? "Atleast 10 digits required"
          : "";
        setMobile(value);
        setMsg(false);
      ...
      case "password":
        isError.password =
          value.length === 0
            ...
            : value.length < 6
            ? "Atleast 6 characaters required"
            : "";
        setPassword(value);
        setMsg(false);
        setServerError(false);
              ...
              <div className="card mt-4">
                <div className="card-body p-0">
                  <div className="row m-0">
                    <div className="col-xl-6 col-lg-6 col-md-5 col-sm-12 sign text-center">
                      <div>
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-7 col-sm-12">
                      <div className="sign-in-your">
                        <h4 className="fs-20 font-w600 text-primary">
                        ...
                        <form onSubmit={onSubmit}>
                          ...
                          <p
                            className="loginerror mt-1"
                            style={{ color: "red" }}
                          >
                            <strong>{state.isError.mobile}</strong>
                          </p>
                          <label className="mb-2 fs-16">
                          ...
                          <div className="input-group">
                            <span className="input-group-text">
                              {" "}
                              <i
                                className="bi bi-shield-lock fs-20"
                                style={{ color: "#886FFE" }}
                              />
                            </span>
                            <input
                            ...
                            />
                            <span
                              className="input-group-text show-pass showpass"
                          ...
                          <p
                            ...
                            style={{ color: "red" }}
                          >
                            <strong>{state.isError.password}</strong>
                          </p>
                          {msg ? (
                            <h4
                              style={{ color: "red" }}
