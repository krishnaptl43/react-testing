    ...
    <>
      <div>
        <Link to={`/${ROUTE.SUBSCRIPTION}`}>
          {isHamburgerActive ? (
            <img
              className="active-logo nav-header bg-black"
              src="https://imagnus.in/images/favicon.png"
              alt="logo"
              style={{ width: "6.5rem" }}
            />
          ) : (
            <img
              className="nav-header bg-black"
              src="https://imagnus.in/images/logo.png"
              alt="logo"
              style={{ width: "15rem" }}
            />
          )}
            ...
            <div className="collapse navbar-collapse justify-content-between">
              <div className="header-left">
                ...
                <div className="nav-control">
                  <div className={
                      isHamburgerActive ? "hamburger is-active" : "hamburger"
                    }
                    onClick={() => {
                      toggle();
                    }}
                ...
                <div className="dlab-side-menu">
                  ...
                  <div className="sidebar-social-link ">
                    <ul>
                      <li className="nav-item dropdown notification_dropdown">
                        <Link
                          className={
                            showNotification ? "nav-link show" : "nav-link"
                          }
                                ...
                                <div className="timeline-panel">
                                  ...
                                  <div className="media-body">
                                    ...
                                    <small className="d-block">
                                      {show_date?.toLocaleDateString(
                                        "hi-IN",
                                        options
                                      )}
                                      -{show_date?.toLocaleTimeString()}
                                    </small>
                                  </div>
                                </div>
                              </li>
                  ...
                  <ul>
                    <li className="nav-item dropdown header-profile mt-2">
                      <Link
                        className={dp ? "nav-link show" : "nav-link"}
                        role="button"
                        data-bs-toggle="dropdown"
                        aria-expanded={dp ? true : false}
                        onClick={() => {
                          setDp(!dp);
                        }}
                      >
                        <img
                          src={profileData && profileData?.dp}
                          width={20}
                          alt=""
                        />
                      </Link>
